...
class UserProfileForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'country', 'Gender', 'annual_income', 'currency', 'four_digit_auth_key'
        ]
        widgets = {
...
class MIFForm(forms.Form):
    mid_code = forms.CharField(required=True, label="MID Code")
    national_id_card = forms.FileField(required=False)
    bank_card = forms.FileField(required=False)
    ssn_number = forms.CharField(required=False)
